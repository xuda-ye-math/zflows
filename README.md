...
> **Note.** GitHub's markdown viewer renders LaTeX math via MathJax but is fragile around `aligned`. The blocks below have been formatted to be GitHub-friendly; for the cleanest rendering, clone the repository and open `README.md` in VS Code.
